...
import { Box, StatusBar, HStack, IconButton, Icon, Center } from "native-base";
    ...
    return (
      ...
      <HStack bg="coolGray.100" px="1" py="3" justifyContent="space-between" alignItems="center" w="100%">
        ...
        <ScrollView contentContainerStyle={{ padding: 32 }}>
          ...
          <Text style={{fontWeight:"700" ,fontSize: 20 , margin: 5}}>1. Account</Text>
          <Text>
          ...
          <Text style={{fontWeight:"700" ,fontSize: 20 , margin: 5}}>2. Service</Text>
          <Text>
          ...
          <Text style={{fontWeight:"700" ,fontSize: 20 , margin: 5}}>3. Privacy</Text>
          <Text>
          ...
          <Text style={{fontWeight:"700" , fontSize: 20 , margin: 5}}>4. Content</Text>
          <Text>
